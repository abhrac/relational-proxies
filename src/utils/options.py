...
class Options:
    def __init__(self):
        ...
        # Data
        parser.add_argument("--data_root", default="~/Datasets/", help="Root directory for all datasets.")
        ...
        parser.add_argument("--logdir", default="./checkpoint/logdir/", help="Location of logging directory.")
